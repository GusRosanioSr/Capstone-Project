<?php
	...
	{	
		...
		else
		{
			...
			$insertSQL = "INSERT INTO `google maps` (`street`, `road`, `town`, `county`, `state`, `country`, `zip code`, `latitude`, `longitude`, `full address`) 
						  VALUES('$street', '$road', '$town', '$county', '$state', '$country', '$zip', '$lat', '$lng', '$full_address')";
	...
	/*  hey asshole. what your gonna have to do to retrieve data from dickersons database is select from tables with values
		of a certain value. start with the actual number spot in the database. just work your way down (or up since your
		using number) and take the latitude and longitude. then assign them to the appropriate variables.
		look up a new location based on those two values. after that take all of the data you get back from google
		and park it into your database. 
	*/
?>